    ...
    <div className={classes['cart-item']}>
      ...
      <div className={classes['price-quantity-wrapper']}>
        <div className={classes['price-wrapper']}>
          <span className={`${classes.price} ${discount && classes['discount-price']}`}>{totalPrice} с</span>
          {discount && <span className={classes['price-without-discount']}>{totalPriceWithoutDiscount} с</span>}
        </div>
